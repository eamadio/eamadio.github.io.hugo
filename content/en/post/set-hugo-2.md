...
1. First Repository for the hugo project `eamadio.github.io.hugo`
2. Second repository to host my blog as Github User page `eamadio.github.io`
    ...
    steps:
      ...
      - name: Deploy
        ...
        with:
          ...
          publish_dir: ./public
          external_repository: eamadio/eamadio.github.io
          publish_branch: main
          user_name: emadio
...
1. ["hugo" Project Repository](https://github.com/eamadio/eamadio.github.io.hugo)
2. [Blog Repository](https://eamadio.github.io/)
